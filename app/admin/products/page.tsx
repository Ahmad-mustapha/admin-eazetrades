...
'use client'; // If using onClick handlers in App Router
...
const productsListData: ProductListItem[] = [
  ...
  },
  {
   ...
   {
    id: 'prod-006',
    imageUrl: '/phone.png', // Assuming different image or same
    name: 'Microsoft Headsquare',
    category: 'Digital Product',
    price: 43000,
    quantity: 13,
          ...
          <table className="min-w-full w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-gray-200">
                ...
                <th className="py-3 px-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Product Name</th>
